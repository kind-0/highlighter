...
">
    <div class="font-normal">
        {#if value === 'Public'}
            Public (as <Name pubkey={$currentUser?.hexpubkey()} />)
    ...
    <li class="rounded hover:bg-gray-100 dark:hover:bg-gray-600 px-4 py-4 border-b border-b-zinc-200">
        <Radio bind:group={value} value='Public'>
            <div class="flex flex-col pl-1">
                <span class="text-base">Public (as <Name pubkey={$currentUser.hexpubkey()} />)</span>
    ...
    {#if delegatedName}
        <li class="rounded hover:bg-gray-100 dark:hover:bg-gray-600 px-4 py-4 border-b border-b-zinc-200">
            <Radio bind:group={value} value='Delegated'>
                <div class="flex flex-col pl-1">
                    <span class="text-base">Public (as {delegatedName})</span>
